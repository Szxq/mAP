...
class YOLO(object):
    def __init__(self):
        self.model_path = 'models/ep_new_data140-loss14.025-val_loss13.710.h5' # model path or trained weights path
        self.anchors_path = 'conf/yolo_anchors.txt'
        self.classes_path = 'conf/people.txt'
        self.score = 0.15
        self.iou = 0.45
